    ...
    return (
          <main style={{ padding: 24, maxWidth: 900, margin: "0 auto" }}>
                ...
                <p style={{ color: "#666", marginBottom: 32 }}>
                        Browse our 13 specialist AI marketing agents. Purchase lifetime access,
                        a subscription, or a usage pack from our{" "}
                        <a
                ...
                <div
                  ...
                  {AGENT_REGISTRY.map((agent) => (
                                    <Link
                                                ...
                                                >
                                                <h2 style={{ fontSize: 16, margin: "0 0 8px" }}>{agent.name}</h2>h2>
